...
class constPath
{
    const TicketImage  = '/jambasangsang/assets/tickets/images';
    const ModuleImage  = '/jambasangsang/assets/modules/images';
    ...
    const DefaultImage  = '/jambasangsang/placeholder_1.png';
    const LessonResource  = '/jambasangsang/assets/lesson_resources';
    const PaymentProof  = '/jambasangsang/assets/payment_proof';
    const SubmissionFile  = '/jambasangsang/assets/submission_file';
    const CommentAttachment  = '/jambasangsang/assets/comment_attachments/images';
}
