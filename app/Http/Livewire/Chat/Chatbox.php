...
$this->receiverInstance= null;
    ...
    function broadcastedMessageReceived($event)
    {
      ...
      $this->emitTo('chat.chat-list','refresh');
        ...
        $broadcastedMessage = ConversationMessage::find($event['message']);
    ...
    function loadmore()
    {
        ...
        $this->messages_count = ConversationMessage::where('conversation_id', $this->selectedConversation->id)->count();

        $this->messages = ConversationMessage::where('conversation_id',  $this->selectedConversation->id)
    ...
    public function loadConversation(Conversation $conversation, User $receiver)
    {
        ...
        ConversationMessage::where('conversation_id',$this->selectedConversation->id)
    ...
    {
        return view('livewire.backend.chat.chatbox');
    }
}
