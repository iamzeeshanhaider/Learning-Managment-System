                            ...
                            @if (!empty($course_id))
                                <div class="col-md-5">
                                    <img src="{{ $course->instructor->image() }}" alt=""
                                        class="mr-3 user-avatar custom-avatar rounded-circle">
                                    <label for="" class="mt-3 mb-3"> {{ $course->instructor->name }}</label>
                                    <br><br>
                                    <i class="fa fa-envelope-o" aria-hidden="true"></i> <label for="">
                                        {{ $course->instructor->email }}</label> <br>
                                    <i class="fa fa-code-fork" aria-hidden="true"></i> <label for="">
                                        {{ $course->instructor->code }}</label> <br>
                                    <label for=""> {{ $course->instructor->designation }}</label> <br>
                                </div>
                                <div class="col-md-5" wire:ignore>
                                    ...
                                    <ul class="enrolment">
                                        ...
                                        <li> @lang('Start Date'): {{ $course->start_date->format('d M Y') }}</li>
                                        <li> @lang('Finished Date'): {{ $course->end_date ? $course->end_date->format('d M Y') : '' }}</li>
