            ...
            @foreach ($conversations as $conversation)
                ...
                >
                    <div class="chatlist_img_container">
                        ...
                        <img src="https://ui-avatars.com/api/?name={{$conversation->name}}"
                            alt="">
                    </div>
                    ...
                    <div class="chatlist_info">
                        <div class="top_row">
                            {{$conversation->name}}
                            <span class="date">
                              {{ $conversation->broadcast->last() ? $conversation->broadcast->last()->created_at->shortAbsoluteDiffForHumans() : '' }}                            </div>

                        <div class="bottom_row">

                            <div class="message_body text-truncate">
                              {{ $conversation->broadcast->last() ? $conversation->broadcast->last()->message : '' }}
                            </div>
