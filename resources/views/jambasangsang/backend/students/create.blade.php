                            ...
                            <div class="card-body">
                                <form action="{{ route('users.store') }}" method="post" novalidate="novalidate">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group has-success">
                                                ...
                                                <input id="name" name="name" type="text" class="form-control name valid"
                                                    data-val="true" data-val-required="{{ __('Please enter user name') }}"
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input id="email" name="email" type="email"
                                                    class="form-control email identified visa" value="" data-val="true"
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="photo" class="control-label mb-1">@lang('photo')</label>
                                                <input id="photo" name="photo" type="photo" class="form-control photo"
                                                    value="" autocomplete="photo">
