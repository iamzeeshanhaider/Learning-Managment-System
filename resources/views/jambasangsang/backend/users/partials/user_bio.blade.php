            ...
            <div class="mt-3 card border-0 shadow">
                <ul class="list-group list-group-flush">
                    <li class="flex-wrap list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <span class="text-secondary">{{ count($user->courses) }}</span>
                    </li>
                    <li class="flex-wrap list-group-item d-flex justify-content-between align-items-center">
                    ...
                    @if ($user->activities->last())
                        <li class="flex-wrap list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <span
                                class="text-secondary">{{ ucfirst(strtolower($user->activities->last()->action)) . ' ' . $user->activities->last()->module_name }}</span>
                        </li>
                    @endif
                </ul>
            </div>
