            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="single-course-left mt-30">
                                    ...
                                    <div class="instructor-name">
                                        <div class="thum">
                                            <img src="{{ $course->instructor->image() }}"
                                                alt="{{ $course->instructor->name }}" width="50" height="50">
                                        </div>
                                        <div class="name">
                        ...
                        <div class="single-course-image pt-50">
                            ...
                            <ul class="nav nav-justified" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="active" id="overview-tab" data-toggle="tab" href="#overview" role="tab"
                                        aria-controls="overview" aria-selected="true">@lang('Overview')</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <div class="col-md-6">
                                    <div class="single-course mt-30">
                                        ...
                                        <div class="cont">
                                            ...
                                            @include('jambasangsang.frontend.courses.instructors')
                                        </div>
                                    </div> <!-- single course -->
                                </div>
                            @endforeach
