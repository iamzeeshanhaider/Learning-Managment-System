...
@section('content')
    ...
    <section id="page-banner" class="pt-105 pb-110 bg_cover" data-overlay="8"
        style="background-image: url('{{ asset('jambasangsang/frontend/images/page-banner-3.jpg') }}')">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-4">
                        <div class="events-right">
                            <div class="events-coundwon bg_cover" data-overlay="8"
                                style="background-image: url(images/event/single-event/coundown.jpg)">
