...
@section('content')
    ...
    <section id="instructors-single" class="pt-70 pb-120 gray-bg">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-8">
                    <div class="instructors-left mt-50">
                        <div class="hero">
                ...
                <div class="col-lg-8">
                    <div class="instructors-right mt-50">
                                            ...
                                            <div class="single-course mt-30">
                                                ...
                                                <div class="cont border">
                                                    ...
                                                    <div class="course-instructor">
                                                        <div class="thum">
                                                            <a href="#"><img src="images/course/instructor/t-2.jpg"
                                                                    alt="instructor"></a>
                                                        </div>
                                                        <div class="name">
                                                            <a href="#">
