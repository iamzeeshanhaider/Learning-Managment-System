<section id="video-feature" class="bg_cover pt-60 pb-110"
    style="background-image: url('{{ asset('jambasangsang/frontend/images/bg-1.jpg') }}')">
    <div class="container">
                    ...
                    <ul>
                        <li>
                            <div class="single-feature">
                                <div class="icon">
                                    <img src="{{ asset('jambasangsang/frontend/images/all-icon/f-1.png') }}"
                                        alt="icon">
                                </div>
                                <div class="cont">
                        ...
                        <li>
                            <div class="single-feature">
                                <div class="icon">
                                    <img src="{{ asset('jambasangsang/frontend/images/all-icon/f-2.png') }}"
                                        alt="icon">
                                </div>
                                <div class="cont">
                        ...
                        <li>
                            <div class="single-feature">
                                <div class="icon">
                                    <img src="{{ asset('jambasangsang/frontend/images/all-icon/f-3.png') }}"
                                        alt="icon">
                                </div>
                                <div class="cont">
                                    <h4>Books & Library</h4>
