        ...
        <div class="row justify-content-center">
            <div class="col-lg-3 col-md-6 col-sm-8">
                <div class="single-publication mt-30">
                    <div class="image">
                        <img src="{{ asset('jambasangsang/frontend/images/publication/p-1.jpg') }}" alt="Publication">
                        <div class="add-cart">
                            <ul>
            ...
            <div class="col-lg-3 col-md-6 col-sm-8">
                <div class="single-publication mt-30">
                    <div class="image">
                        <img src="{{ asset('jambasangsang/frontend/images/publication/p-2.jpg') }}" alt="Publication">
                        <div class="add-cart">
                            <ul>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                <li><a href="#"><i class="fa fa-heart-o"></i></a></li>
            ...
            <div class="col-lg-3 col-md-6 col-sm-8">
                <div class="single-publication mt-30">
                    <div class="image">
                        <img src="{{ asset('jambasangsang/frontend/images/publication/p-3.jpg') }}" alt="Publication">
                        <div class="add-cart">
                            <ul>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                <li><a href="#"><i class="fa fa-heart-o"></i></a></li>
            ...
            <div class="col-lg-3 col-md-6 col-sm-8">
                <div class="single-publication mt-30">
                    <div class="image">
                        <img src="{{ asset('jambasangsang/frontend/images/publication/p-4.jpg') }}" alt="Publication">
                        <div class="add-cart">
                            <ul>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                <li><a href="#"><i class="fa fa-heart-o"></i></a></li>
