...
@section('content')
    ...
    <tr>
        <td class="left-text" align="left"
            ...
            <div>
                <p>
                    We hope this email finds you well. We wanted to inform you about an upcoming quiz for the
                    {{ $data['course_title'] }}. Please take note of the following details:
                </p>
            </div>
        </td>
    </tr>
    ...
    <tr>
        <td class="left-text" align="left"
            style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:300;font-style:normal;text-decoration:none;letter-spacing:0px;">
            <p>
                The quiz will be an opportunity for you to test your understanding of the course material and assess your
                progress. We encourage you to review the relevant chapters, lecture notes, and any additional resources
                provided by the instructor to prepare effectively.
            </p>
        </td>
    </tr>
    <tr>
            ...
            <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="center-float">
                <tr>
                    <td align="center" bgcolor="#d6df58" style="border-radius: 6px;">
                        <a href="{{ $data['quiz_url'] }}" target="_blank" class="main-btn"><span>View Quiz</span></a>
                    </td>
                </tr>
            </table>
        </td>
